...
#>  Intel fortran compiler......................................................
    case intel:
        ...
        setenv IOAPI_MOD_DIR   /tng7/users/jjung/CMAQ_5.2/IOAPI/ioapi/fixed_src   #> I/O API precompiled modules
        setenv IOAPI_INCL_DIR  /tng7/users/jjung/CMAQ_5.2/IOAPI/Linux2_x86_64ifort   #> I/O API include header files
        setenv IOAPI_LIB_DIR   /tng7/users/jjung/CMAQ_5.2/IOAPI/Linux2_x86_64ifort   #> I/O API libraries

        setenv NETCDF_LIB_DIR  /opt/netCDF/lib #netcdf_lib_intel #> netCDF directory path
        setenv NETCDF_INCL_DIR /opt/netCDF/include #netcdf_inc_intel #> netCDF directory path
        setenv MPI_LIB_DIR     /opt/intel/compilers_and_libraries_2018.1.163/linux/mpi/intel64  #mpi_lib_intel    #> MPI directory path
        ...
        setenv myFFLAGS "-g -fixed -132 -funroll-loops"
        setenv myFRFLAGS "-free"
        setenv myCFLAGS "-O2 -lcurl"
        setenv extra_lib "-L/usr/lib64 -lcurl"
        #setenv extra_lib ""
...
#> I/O API, netCDF, and MPI libraries
 setenv netcdf_lib "-lnetcdff -lnetcdf -L/opt/HDF5/lib -lhdf5 -lhdf5_hl -lcurl"  #> -lnetcdff -lnetcdf for netCDF v4.2.0 and later
...
#> Check for netcdf and I/O API libs/includes, error if they don't exist
 ...
 if ( ! -e $IOAPI_DIR/include_files/m3utilio.mod ) then 
